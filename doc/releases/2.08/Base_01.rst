...
**tune\_V:** \* A Ending Chord change is defined. It replaces the normal
pattern at the end. \* the first voice has a diffrent pattern. It palys
on the Blues scale. \* Three Piano voices play in a range of an octave
and generete together the chords of the extended Blues scheme
